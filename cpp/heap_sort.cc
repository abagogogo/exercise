...
// Heap definiition: an array object that can be viewed as a nearly complete tree.
// Heap property: max-heap property: A[parent(i)] >= A[i] -> root is the max.
